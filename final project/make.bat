...
del guessing.lst	REM guessing可以替換成.asm檔的檔名
del guessing.obj
del guessing.ilk
del guessing.pdb
del guessing.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:guessing.exe guessing.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
